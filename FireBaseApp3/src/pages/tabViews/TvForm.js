...
import {
  ...
  FlatButtonContainer, Footer, IconAwesomeStacked, ImageButton,
      ...
      <div>
        ...
        <Grid>
          <Card title="Form" description="Form styles and utilities">
            ...
            <input type="range" className="light" onChange={(event)=>{console.log('range changed', event.target.value);}} />
            <Separator padding={10} color="white" />
            <div className="select_style" onChange={(event)=>{console.log('select changed', event.target.value);}}>
              <select>
            ...
            <Separator padding={10} color="white" />
            <input id="box1" name="checkBoxTest" type="checkbox" className="chk circle" defaultChecked />
            <label htmlFor="box1">Checkbox 1 </label>
            <input id="box3" name="checkBoxTest" type="checkbox" className="chk circle" />
            <label htmlFor="box3">Checkbox 3 </label>
            <input id="box2" name="checkBoxTest" type="checkbox" className="chk square" />
        ...
        <Grid>
          ...
          <Card title="<ImageButton />">
            <ImageButton icon="fa-refresh" label="Refresh"/>
            <ImageButton icon="fa-camera" label="Error" type='danger'/>
          </Card>

          <Card title="<IconAwesomeStacked />">
            <IconAwesomeStacked icon="fa-refresh" stackIcon='fa-circle' label="Refresh" />
            <IconAwesomeStacked icon="fa-refresh" stackIcon='fa-circle-o' color='auto' label="Refresh"/>
            <IconAwesomeStacked icon="fa-twitter" stackIcon='fa-square' label="Refresh" />
            <IconAwesomeStacked icon="fa-twitter" stackIcon='fa-square-o' color='auto' label="Refresh" />
          </Card>
